        ...
        <div className='WhatsItAbout'>
            ...
            <div className='WhatsItAbout-info'>
                <div className='WhatsItAbout-info-column'>
                    <h3 className='WhatsItAbout-info-column__title title1'>Pick things</h3>
                ...
                <div className='WhatsItAbout-info-column'>
                    <h3 className='WhatsItAbout-info-column__title title3'>Decide who to help</h3>
                    <p className='WhatsItAbout-info-column__text'>choose a trusted place</p>
                </div>
                <div className='WhatsItAbout-info-column'>
                    <h3 className='WhatsItAbout-info-column__title title4'>Book a courier</h3>
